...
public class FloatingActionButton extends FrameLayout {
    ...
    public FloatingActionButton(Context context, ViewGroup.LayoutParams layoutParams,
                                Drawable backgroundDrawable, int position, ViewGroup parentView,
    ...
    public void setPosition(int position, ViewGroup.LayoutParams layoutParams) {
        ...
        if(!systemOverlay) {
            ...
            try {
                ...
                lp.gravity = gravity;
                if(setDefaultMargin) {
                    int margin =  getContext().getResources().getDimensionPixelSize(R.dimen.zero_px_margin);
                    lp.x = margin;
                    lp.y = margin;
                }
                setLayoutParams(lp);
    ...
    public void setContentView(View contentView, FrameLayout.LayoutParams contentParams) {
        ...
        if(contentParams == null ){
            ...
            final int margin = getResources().getDimensionPixelSize(R.dimen.zero_px_margin);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            ViewGroup.LayoutParams layoutParams = new LayoutParams(size, size, Gravity.BOTTOM | Gravity.START);
        ...
        public Builder(Context context, int size) {
            ...
            this.layoutParams = new LayoutParams(size, size, Gravity.BOTTOM | Gravity.START);
            setLayoutParams(layoutParams);
            setPosition(FloatingActionButton.POSITION_BOTTOM_CENTER);
            setSystemOverlay(false);
        }
        ...
        public Builder setParentView(ViewGroup container) {
