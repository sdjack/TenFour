 ...
 * Sliding navigation and container drawers
 */
public class SlidingDrawer extends ViewGroup {
    ...
    private void moveHandle(int position) {
        ...
        if (mOnDrawerMoveListener != null) {
            mOnDrawerMoveListener.onDrawerMoved();
        }
    }
    ...
    public void setOnDrawerMovedListener(OnDrawerMoveListener onDrawerMoveListener) {
