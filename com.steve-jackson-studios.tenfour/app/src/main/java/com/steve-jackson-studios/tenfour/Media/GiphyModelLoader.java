 ...
 */
public class GiphyModelLoader extends BaseGlideUrlLoader<GiphyApi.GifResult> {

    @Override
    public boolean handles(GiphyApi.GifResult model) {
        return true;
    }
     ...
     */
    public static class Factory implements ModelLoaderFactory<GiphyApi.GifResult, InputStream> {


        @Override
        public ModelLoader<GiphyApi.GifResult, InputStream> build(MultiModelLoaderFactory multiFactory) {
    ...
    @Override
    protected String getUrl(GiphyApi.GifResult model, int width, int height, Options options) {
        GiphyApi.GifImage fixedHeight = model.images.fixed_height;
        int fixedHeightDifference = getDifference(fixedHeight, width, height);
        GiphyApi.GifImage fixedWidth = model.images.fixed_width;
    ...
    private static int getDifference(GiphyApi.GifImage gifImage, int width, int height) {
