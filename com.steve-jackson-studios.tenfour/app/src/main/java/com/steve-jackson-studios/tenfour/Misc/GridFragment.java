...
public class GridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pframe.setId(R.id.progressContainer);
        ...
        lframe.setId(R.id.gridContainer);

        TextView tv = new TextView(getActivity());
        tv.setId(R.id.gridEmpty);
        ...
        lframe.addView(grid, new FrameLayout.LayoutParams(
                ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
    ...
    private void ensureList() {
        ...
        if (root instanceof GridView) {
            ...
            mStandardEmptyView = (TextView)root.findViewById(R.id.gridEmpty);
            if (mStandardEmptyView == null) {
            ...
            mListContainer = root.findViewById(R.id.gridContainer);
